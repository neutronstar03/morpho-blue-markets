...
import { useLocalCollateralBlacklistVersion } from '../local-collateral-blacklist'
...
export function useMarketRiskStatus(market: MarketRiskInput) {
  ...
  }, [market, version, whitelistVersion, localBlacklistVersion, blacklistVersion])
}
...
export function useExecutionGuard(markets: MarketRiskInput[]) {
  ...
  }, [markets, version, whitelistVersion, localBlacklistVersion, blacklistVersion])
}
