...
- v1.6.11: Positions now combines direct wallet markets with Vault V2 adapter rows again, with a live regression for the msY wallet case.
...
- `v1.6.11` (2026-06-22): Positions now combines direct wallet markets with Vault V2 adapter rows again, with a live regression for the msY wallet case.
