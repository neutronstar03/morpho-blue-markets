...
export const supportedChains = [arbitrum, base, katana, mainnet, optimism, polygon, unichain, hyperEvm] as const
...
export function getSupportedChainName(chainId: number | null | undefined) {
  if (chainId == null)
    return 'Unspecified'
